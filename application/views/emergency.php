<div class="top_content">
	<div class="row"> 
            <div class="col-sm-10 col-sm-offset-1 text-left breadcrumb"><h5><a href='<?php echo base_url(); ?>'>Home</a> > <a href='go_emergencyview'>Emergency</a></h5></div>
    </div>
</div>
...
<form action="go_emergencyview" class="pull-right" method="post">
...
<?php 
  ...
  ?>
<div class="media" style="border-bottom: 1px solid #269abc;">
  <div class="media-body">
    <h2 class="media-heading"><?php echo $value->name ?></h2>
    <p><b>Category: </b><?php echo $value->category; ?></p>
